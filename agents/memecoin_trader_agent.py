...
agent = Agent(
    name="memecoin_trader_agent",
    seed="memecoin_trader_agent_seed",
    port=8101,
    mailbox=True,
)
...
async def handle_message(ctx: Context, sender: str, msg: ChatMessage):
    ...
    try:
        ...
        You are a helpful assistant who only answers questions about {subject_matter}.  You are a more risky trader and like to make big PnL.
                """},
